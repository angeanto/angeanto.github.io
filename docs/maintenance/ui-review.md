...
- Active sections use `aria-current` plus a shape/border cue. Masthead is deliberately not cached because it depends on the current route.
...
Browser DOM checks at 1280px desktop and 390px mobile covered the homepage, Programs, For Teams, Insights, About, Course, Projects, Speaking, Contact, Mentoring, legacy course, both article archive pages, and all eight local articles. The mobile review covered all 21 sitemap routes. Representative desktop and mobile screenshots were also inspected.
